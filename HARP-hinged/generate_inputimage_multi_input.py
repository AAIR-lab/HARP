...
class InputGenerator():
    ...
    def setupRobot(self):
        if self.robot.GetName() == 'robot1' or self.robot.GetName() == "bot":
            ...
            self.robot.SetDOFLimits(list(self.bounds[0]) + [-np.pi/2], list(self.bounds[1]) + [np.pi/2])
...
if __name__ == '__main__':
    ...
    # goal_loc = [6.3, -7.1, 0, 0] # 30.0.1
    # goal_loc = [-8.5,-7.1, 0, 0] # 31.0.1
    goal_loc = [8.8, 9, 0, 0] # 32.0.1

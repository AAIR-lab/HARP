...
class LabelGenerator():
    ...
    def buildLabel(self):  
        ...
        dof_3_channel = dof_3_channel.reshape(pd_xy.shape)
        dof_4_channel = dof_4_channel.reshape(pd_xy.shape)
        ...
        assert pd.shape[0] == self.number_of_bins and pd.shape[1] == self.number_of_bins and pd.shape[2] == self.robot.GetActiveDOF() - 1

...
class PDVisualizer(object):
    ...
    def make_image(self):
        ...
        xy_image = np.zeros((inp.shape[0],inp.shape[0]))
        ...
        xy_image = xy_image.reshape((inp.shape[0],inp.shape[0],1))
        xy_image_green_channel = xy_image_green_channel.reshape((inp.shape[0],inp.shape[0],1))
        xy_image_red_channel = xy_image_red_channel.reshape((inp.shape[0],inp.shape[0],1))
        ...
        dof_image_0 = dof_image_0.reshape((inp.shape[0],inp.shape[0],1))
        dof_image_1 = dof_image_1.reshape((inp.shape[0],inp.shape[0],1))
        dof_image_2 = dof_image_2.reshape((inp.shape[0],inp.shape[0],1))

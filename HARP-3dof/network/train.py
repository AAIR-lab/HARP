...
model_name = 'se2-3dof-dan'

tf.app.flags.DEFINE_string('ckpt_dir', './ckpts-dan', 'Train checkpoint directory')
tf.app.flags.DEFINE_string('ckpts_path', './ckpts-dan/model.ckpt', 'Train checkpoint file path')
...
tf.app.flags.DEFINE_float('learning_rate', 1e-05, 'learning rate for optimizer')

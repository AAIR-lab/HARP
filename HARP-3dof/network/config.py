...
working_dataset = 'se2-3dof'  # dataset name in input/ folder 
...
number_of_dof = 3  # number of degrees of freedom of robot
number_of_bins = 10  # number of bins each DOF is divided into
input_channels = 6  # number of channels in network input

        ...
        for category in ['train', 'train-labels']:  # iterate over all inputs and labels
            ...
            for sample in samplefiles: 
                ...
                if sample.endswith('.npy') and category == 'train':
                    ...
                    assert inp_tensor.shape[-1] == 11 # should have 17 channels (0-2: env image, 3-8: goal location, 9-14: fetch location)
                    ...
                    assert len(lbl_tensor.shape) == 4
                    assert lbl_tensor.shape[-1] == 9 # should have 1 channels
